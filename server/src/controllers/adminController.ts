...
export const getVendors = CatchErrorFunc(
  async (req: Request, res: Response) => {
...
export const getVendorById = CatchErrorFunc(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
export const createAdmin = CatchErrorFunc(
  async (req: Request, res: Response) => {
...
export const loginnAdmin = CatchErrorFunc(
  async (req: Request, res: Response) => {
